...
// import { Calendar, ChevronDown, Camera, Mail, ArrowLeft, CheckCircle } from 'lucide-react';
...
//     // Show success toast or message here ideally
//   };

//   const handleVerificationCancel = () => {
//     // Revert email if cancelled
...
//             {/* Edit Image Overlay - Visible on Hover or Edit Mode */}
//             <button 
//               onClick={() => fileInputRef.current.click()}
//               className={`absolute bottom-0 right-0 p-3 bg-black text-white rounded-full shadow-lg hover:bg-gray-800 transition-all transform hover:scale-105 ${isEditing ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto'}`}
...
//               disabled={!isEditing && !isEditing} // Allow upload always on hover, or restrict to edit mode? Requirement says "profile image edit too"
//             />
//           </div>
//         </div>
...
//               disabled={!isEditing}
//               className={`w-full p-4 rounded-md bg-gray-100/80 border-transparent focus:bg-white focus:ring-2 focus:ring-black focus:border-transparent transition-all outline-none ${!isEditing ? 'text-gray-500' : 'text-gray-900'}`}
...
//                 onChange={handleInputChange}
//                 disabled={!isEditing}
//                 className={`w-full p-4 rounded-md bg-gray-100/80 border-transparent focus:bg-white focus:ring-2 focus:ring-black focus:border-transparent transition-all outline-none appearance-none ${!isEditing ? 'text-gray-500' : 'text-gray-900'}`}
//               >
//                 <option>Male</option>
...
//               disabled={!isEditing}
//               rows={2}
//               className={`w-full p-4 rounded-md bg-gray-100/80 border-transparent focus:bg-white focus:ring-2 focus:ring-black focus:border-transparent transition-all outline-none resize-none ${!isEditing ? 'text-gray-500' : 'text-gray-900'}`}
