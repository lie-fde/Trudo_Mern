...
//       // 1. Reference the hidden node
//       const node = cardRef.current;

//       // 2. Capture the PNG
//       const dataUrl = await htmlToImage.toPng(node, {
//         cacheBust: true,
//         pixelRatio: 3, // Ensures a very sharp, professional-looking image
//         backgroundColor: '#ffffff',
//         // Forces the library to include the styles even if the node is off-screen
//         style: {
//           left: '0',
//           top: '0',
//           opacity: '1',
...
//       {/* VISUAL MODAL (What the user sees on screen) */}
//       <div className="relative bg-white w-full max-w-sm rounded-[2rem] shadow-2xl overflow-hidden transform transition-all animate-in fade-in zoom-in duration-300">
//         <div className="bg-orange-600 p-4 text-white text-center relative overflow-hidden">
//           <div className="absolute top-3 right-3 z-10">
//             <button
...
//               onError={(e) => {
//                 e.target.src =
//                   "https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=ErrorFetchingQR";
//               }}
//             />
//             {/* Corner Brackets UI */}
//             <div className="absolute -top-1 -left-1 w-4 h-4 border-t-2 border-l-2 border-orange-600 rounded-tl-sm"></div>
...
//           <div className="grid grid-cols-2 gap-3 text-left border-t border-b border-gray-50 py-4 mb-6">
//             <div>
//               <p className="text-[9px] text-gray-400 uppercase font-bold mb-0.5">Date</p>
//               <p className="text-[11px] font-black text-gray-900">{event.date}</p>
//             </div>
//             <div>
//               <p className="text-[9px] text-gray-400 uppercase font-bold mb-0.5">Time</p>
//               <p className="text-[11px] font-black text-gray-900">{event.time}</p>
//             </div>
//             <div className="col-span-2">
//               <p className="text-[9px] text-gray-400 uppercase font-bold mb-0.5">Venue</p>
//               <p className="text-[11px] font-black text-gray-900 line-clamp-1">{event.location}</p>
//             </div>
//           </div>
...
//       {/* HIDDEN TICKET FOR EXPORT (This is the one that gets downloaded) */}
//          <div
//         ref={cardRef}
//         style={{
//           width: "400px",
...
//         }}
//       >
//         <div style={{ backgroundColor: '#EA580C' }} className="p-8 text-white text-center">
//           <h3 className="text-sm font-black uppercase tracking-[0.3em] mb-2">
//             Digital Pass
//           </h3>
//           <p className="text-white text-base font-bold px-8">
//             {event.title}
//           </p>
//         </div>
